...
Codex가 README를 읽고 프로젝트 의도와 규모를 요약한 뒤, 필요한 경우 로드맵과
첫 마일스톤을 추천합니다.
...
## 이미 큰 Spring 프로젝트가 있는 경우

별도 유지보수 모드로 바뀌지 않습니다. Codex가 README, `docs/progress.md`, 빌드
구조와 현재 마일스톤 관련 코드를 확인한 뒤 프로젝트 생성·확장 흐름을 이어갑니다.

전체 기능을 한 번에 구현하지 않고 단계별 로드맵에서 다음 검증 가능한 마일스톤을
선택합니다.
