...
def main()->int:
 ...
 try:
  ...
  updated=dict(completion); updated["state"]="APPLIED_AND_VERIFIED"; updated["postApplyRuntimeVerification"]={"path":report_path.relative_to(root).as_posix(),"sha256":sha(report_path)}
