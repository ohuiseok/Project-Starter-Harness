...
def validate_approval(root:Path,path:Path)->dict:
 ...
 if set(receipt)!={"springImplementationPlanV2ApprovalVersion","state","implementationPlan","view","approvedBy","approvedAt","effects"} or receipt["springImplementationPlanV2ApprovalVersion"]!=1 or receipt["state"]!="APPROVED":raise ValueError("implementation plan v2 approval structure is invalid")
 ...
 expected={"codeDryRunAuthorized":False,"sourceChanged":False,"testsExecuted":False,"gitCommitOrPush":"NOT_RUN"}
